...
const Marketplace = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-foreground mb-2">{t("marketplaceTitle")}</h1>
      <p className="text-muted-foreground mb-8">{t("marketplaceSubtitle")}</p>
          ...
          <div key={p.id} className="bg-card rounded-xl overflow-hidden shadow-card hover:shadow-warm transition-all animate-fade-in" style={{ animationDelay: `${i * 100}ms` }}>
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xl font-bold text-primary">{p.price} {t("currency")}</span>
