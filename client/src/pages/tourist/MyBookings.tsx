...
const MyBookings = () => {
  const { bookings, activities, loading } = useData();
  const { user } = useAuth();
          ...
          <div className="space-y-4">
            {myBookings.map((booking, i) => {
              ...
              return (
                ...
                >
                  {activity && (
                    <img src={activity.image} alt={activity.title} className="w-full md:w-36 h-24 rounded-xl object-cover" loading="lazy" />
                  )}
